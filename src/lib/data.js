...
export const categories = [
    {
        ...
        description: "Latest gadgets and home appliances for modern living",
    ...
    },
    {
        ...
        description: "Beauty, health, and personal care essentials",
        image: "/placeholder.svg?height=200&width=200",
        subcategories: [],
    },
    {
    ...
    },
    {
        ...
        description: "Fresh produce, pantry staples, and specialty foods",
        image: "/placeholder.svg?height=200&width=200",
        subcategories: [],
    },
    {
...
export const subcategories = [
    ...
    },
    {
        ...
        description: "High-quality audio equipment and headphones",
        image: "/placeholder.svg?height=200&width=200",
        categoryId: "electronics",
    },
    {
    ...
    },
    {
        id: "refrigerators",
        name: "Refrigerators",
        description: "Energy-efficient refrigerators for your home",
        image: "/placeholder.svg?height=200&width=200",
        categoryId: "electronics",
    },
    {
    ...
    },
    {
        id: "car-parts",
        name: "Car Parts",
        description: "Replacement parts for various car models",
        image: "/placeholder.svg?height=200&width=200",
        categoryId: "automotive",
    },
    {
        id: "car-care",
        name: "Car Care",
        description: "Products to keep your car clean and maintained",
        image: "/placeholder.svg?height=200&width=200",
        categoryId: "automotive",
    },
    ...
    // Baby Products subcategories
    {
        id: "baby-food",
        name: "Baby Food",
        description: "Nutritious food for babies and toddlers",
        image: "/placeholder.svg?height=200&width=200",
        categoryId: "baby",
    },
    {
        id: "diapers",
        name: "Diapers & Wipes",
        description: "Diapers, wipes, and other baby essentials",
        image: "/placeholder.svg?height=200&width=200",
        categoryId: "baby",
    },
    {
        id: "baby-gear",
        name: "Baby Gear",
        description: "Strollers, car seats, and other baby equipment",
        image: "/placeholder.svg?height=200&width=200",
        categoryId: "baby",
    },
    ...
    // Books subcategories
    {
        id: "fiction",
        name: "Fiction",
        description: "Novels, short stories, and other fiction books",
        image: "/placeholder.svg?height=200&width=200",
        categoryId: "books",
    },
    {
    ...
    },
    {
        ...
        description: "Dresses, tops, and bottoms for women",
        image: "/placeholder.svg?height=200&width=200",
        categoryId: "fashion",
    },
    {
        id: "kids-clothing",
        name: "Kids' Clothing",
        description: "Clothing for children and teenagers",
        image: "/placeholder.svg?height=200&width=200",
        categoryId: "fashion",
    },
    ...
    },
    {
        ...
        description: "Mixers, blenders, and other kitchen gadgets",
        image: "/placeholder.svg?height=200&width=200",
        categoryId: "home-kitchen",
    },
    {
...
export const deliveryOptions = [
    {
        id: "quick",
        name: "Quick Delivery",
        description: "Get your order within 60 minutes",
        price: 5.99,
    ...
    },
    {
        id: "self-pickup",
        name: "Self Pickup",
        description: "Pick up your order from the nearest store",
        price: 0,
        estimatedDelivery: "Ready in 30 minutes",
        icon: "🏪",
    },
    {
        id: "scheduled",
        ...
        price: 3.99,
        estimatedDelivery: "At your chosen time",
        icon: "📅",
    },
];
...
export const products = [
    // Smartphones
    {
        ...
        name: "iPhone 13",
        description:
            "The latest iPhone with A15 Bionic chip, Super Retina XDR display, and advanced camera system.",
        price: 799.99,
        rating: 4.8,
        reviewCount: 1245,
        images: [
    ...
    },
    {
        ...
        description:
            "Flagship Samsung smartphone with Exynos 2100 processor, Dynamic AMOLED display, and 8K video recording.",
        price: 699.99,
    ...
    },
    {
        ...
        name: "Google Pixel 6",
        description:
            "Google's flagship smartphone with Google Tensor chip, 50MP camera, and Android 12.",
        price: 599.99,
        rating: 4.6,
        reviewCount: 756,
        images: [
    ...
    // Laptops
    {
        ...
        description:
            "Powerful laptop with M1 Pro chip, Liquid Retina XDR display, and up to 17 hours of battery life.",
        price: 1999.99,
        rating: 4.9,
        reviewCount: 543,
        images: [
        ...
        inStock: true,
        deliveryOptions: [deliveryOptions[1], deliveryOptions[3]],
    },
    {
        id: "dell-xps-13",
        name: "Dell XPS 13",
        description:
            "Premium ultrabook with 11th Gen Intel Core processor, InfinityEdge display, and long battery life.",
        price: 1299.99,
    ...
    // Audio
    {
        ...
        specifications: {
            ...
            Charging: "More than 24 hours with charging case",
    ...
    // TVs
    {
        ...
        description:
            "Smart TV with Quantum Processor 4K, 100% Color Volume, and Quantum HDR.",
        price: 1299.99,
        rating: 4.6,
        reviewCount: 325,
        images: [
    ...
    // Refrigerators
    {
        id: "samsung-french-door-refrigerator",
        name: "Samsung French Door Refrigerator",
        description:
            "Large capacity refrigerator with Twin Cooling Plus, Digital Inverter Technology, and FlexZone drawer.",
        price: 2499.99,
        ...
        specifications: {
            ...
            Dimensions: '35.75" W x 70" H x 36" D',
        },
        inStock: true,
        deliveryOptions: [deliveryOptions[1], deliveryOptions[3]],
    },
    ...
    // Washing Machines
    {
        ...
        description:
            "Smart washing machine with TurboWash technology, Steam, and AI Direct Drive.",
        price: 999.99,
        rating: 4.7,
        reviewCount: 243,
        images: [
    ...
    // Car Accessories
    {
        ...
        description:
            "Universal car phone mount with strong suction cup and adjustable arm.",
        price: 19.99,
        discountPrice: 14.99,
        rating: 4.5,
        reviewCount: 1243,
        ...
        specifications: {
            Compatibility: "Phones 4-7 inches",
    ...
    // Baby Food
    {
        ...
        description:
            "Pack of 12 organic baby food pouches with various fruit and vegetable blends.",
        price: 24.99,
        rating: 4.8,
        reviewCount: 567,
        images: [
        ...
        specifications: {
            Contents: "12 pouches (4 oz each)",
            Flavors: "Apple, Banana, Carrot, Sweet Potato",
            "Age Range": "6+ months",
            Organic: "Yes",
            Allergens: "None",
    ...
    // Skincare
    {
        ...
        description:
            "Lightweight, non-greasy moisturizer suitable for all skin types.",
        price: 29.99,
        rating: 4.7,
        reviewCount: 876,
        images: [
    ...
    // Fiction Books
    {
        ...
        description:
            "A novel about regret, hope, and second chances by Matt Haig.",
        price: 14.99,
        discountPrice: 12.99,
        rating: 4.6,
        reviewCount: 1432,
    ...
    // Fresh Produce
    {
        id: "organic-fruit-basket",
        name: "Organic Fruit Basket",
        description: "Assortment of fresh, seasonal organic fruits.",
        price: 34.99,
        rating: 4.8,
        reviewCount: 321,
        images: [
        ...
        specifications: {
            Contents: "Apples, Oranges, Bananas, Grapes, Seasonal berries",
            Weight: "Approximately 5 lbs",
            Organic: "Yes",
            Origin: "Varies by season",
            Storage: "Room temperature or refrigerated",
            "Shelf Life": "7-10 days",
        },
        inStock: true,
        deliveryOptions: [deliveryOptions[0], deliveryOptions[1]],
    },
    ...
    // Men's Clothing
    {
        ...
        description:
            "Comfortable, stylish button-down shirt suitable for casual and semi-formal occasions.",
        price: 39.99,
        discountPrice: 29.99,
        rating: 4.5,
        reviewCount: 876,
    ...
    // Furniture
    {
        ...
        description:
            "Stylish and comfortable sofa with clean lines and durable upholstery.",
        price: 899.99,
        rating: 4.6,
        reviewCount: 234,
        images: [
        ...
        specifications: {
            ...
            Weight: "120 lbs",
            Material: "Polyester fabric, hardwood frame",
            "Color Options": "Gray, Blue, Beige",
            Assembly: "Required, tools included",
            "Weight Capacity": '750 lbs  "Gray, Blue, Beige',
            Assembly: "Required, tools included",
...
export async function getCategoryInfo(categoryId) {
    ...
    const url = `${apiBaseUrl}/api/v1/product-categories/${categoryId}/info`;
...
export async function getVendorsForThisFilter(categoryId, subcategoryId) {
    const apiBaseUrl = process.env.NEXT_PUBLIC_API_BASE_URL;
    const url = `${apiBaseUrl}/api/v1/product-categories/${categoryId}/subcategories/${subcategoryId}/vendor`;
    const result = await fetch(url);
    const data = await result.json(); // <- This is critical
    return data;
}
...
export function getFeaturedCategories(limit = 6) {
    const featuredCategories = [...categories].slice(0, limit);
